...
- **Client:** Likely Google (coding-related, external platform evaluation)
- **What it actually is:** You get pointed to web apps built by AI on an external platform and evaluate them. Design quality, UX, front-end implementation, usability. It's basically a code review + design critique combined. "Relatively fast and easy rating tasks" per Admin H.
...
### Coding Projects Entry Test (Qualification)
- **Rate:** Unlocks $50+/hr projects
- **What it actually is:** A qualification assessment — pass it and you get access to the premium coding tier. The coding tier involves: reviewing AI-generated code for correctness, catching race conditions, verifying algorithmic complexity, auditing security-critical code paths, writing production-quality corrections. DA's public page says "starting at $50+/hour."
- **Domains covered:** Systems & Infrastructure, Algorithms & Data Structures, Security & Cryptography, Backend & API Design, Frontend & Performance (React/Next.js, bundle optimization, hydration strategies).
- **Why it matters:** This is the ceiling. $50+/hr is 25% more than TH8 and it's Jeff's actual engineering skillset. The entry test has been sitting in-progress for 3 days with a 3-month expiration.
- **Status:** IN PROGRESS — started 3 days ago, expires in ~3 months
- **Strategy:** Don't rush, but don't forget. This is the long-term play. The Frontend & Performance track (React/Next.js, accessibility, performance) is the most natural fit.

---

## 🥈 TIER 2 — "SOLID WORK, GOOD MONEY"
...
## 📦 TIER 4 — "QUALIFICATIONS & GATEWAYS"

### Patroclus — Google RaterHub
- **Rate:** TBD
- **What it actually is:** A qualification for Google's RaterHub platform. Came as an invite after completing Achilles work. Required jefferykerr@gmail.com signup, US residency confirmation.
- **Status:** LIKELY EXPIRED — qualification deadline was ~8:20 PM May 14. It's now past 11 PM. May still be accessible but don't count on it.

### Bluebird — Voice Conversations with AI
- **Rate:** Unlocks $32/hr+ projects
- **What it actually is:** Qualification survey — asks if you're willing/able to have voice conversations with AI. Completing this opens a tier of voice-based evaluation projects.
- **Status:** Available (1 task) — marked "Most work available"
- **Strategy:** Worth completing if Jeff is willing to do voice work. $32/hr+ is solid.

### Metis Qualifications (Various)
- **ChatGPT Export:** Unlocks high-priority Metis projects if you upload a recent ChatGPT export
- **Android Phone + Voice:** Opens high-priority Metis projects for Android voice recording
- **Weekly Gemini Usage:** Quick survey about Gemini usage patterns
- **Status:** All available as 1-task qualifications

---

## 🪦 GRAVEYARD — "Gone But Not Forgotten"

These projects have disappeared from the dashboard but could return.

| Project | Rate | What It Was | Last Seen | Notes |
|---------|------|-------------|-----------|-------|
| Circe Flamingo [G117] | $32/hr (+$2 priority) | UI evaluation, Flamingo platform | May 2 | Queue filled over weekend |
| Circe Widget [G118] | $25/hr | Interactive widget evaluation | May 2 | Gone |
| Achilles Factuality (Shopping) | $25/hr | Shopping-focused fact checking | May 2 | Gone |
| Google AI vs Claude (Health) | $25/hr | Rate & Review, health domain | May 2 | Gone |
...
## 📊 PROJECT FAMILY DECODER

DA uses codenames. Here's what maps to what:
...
| **Circe** | Google (Flamingo) | UI/Component annotation | Design-adjacent |
| **Pegasus** | Google | Drive/Email integration | Google product evals |
| **TH-series** | Google (likely) | Coding/Web app eval | Premium tier, Jeff's sweet spot |
...
## 🧠 JEFF'S PERSONAL PLAYBOOK

### What to jump on immediately:
1. **TH-series** (TH5/TH8/TH9/TH10) — $40/hr, design evals, his wheelhouse
2. **Circe Flamingo** variants with priority pay — $30-32/hr, design-adjacent
3. **Any Metis with +$4 priority** — brings it to $32/hr

### What to grind when nothing else is available:
1. **Metis base projects** — $28/hr, always cycling
2. **Circe G119** — $27/hr, UI work
3. **Acheron** — $26/hr, multi-model chat

### What to avoid (unless desperate):
1. **Styx sub-$22** — Low pay for the effort
2. **Grapefruit** — $24/hr is fine but it's always there as last resort

### Long-term moves:
1. **Complete the Coding Entry Test** — opens $50+/hr
2. **Complete Bluebird** — opens $32+/hr voice projects
3. **Upload ChatGPT export for Metis** — unlocks higher-priority assignments

---

*This dossier is updated every session. The AI reads this file on startup and updates it with new projects, disappeared projects, and Jeff's notes after each work session.*
