---
description: How to execute a Data Annotation task using the Screenshot-to-Response pipeline
---

# Data Annotation Task Execution Workflow

This is the "Strategic Teammate" protocol for earning $20-$40/hr on DataAnnotation tasks.

## CRITICAL SAFETY RULES
- **NEVER** automate the DA browser. No Selenium, Playwright, or bot tools on dataannotation.tech
- **NEVER** copy-paste AI text into the portal. User manually types EVERYTHING
...
- User takes high-res screenshot(s) of the task/prompt on DA
...
- AI identifies what type of task it is:
  - **Response Comparison** → Evaluate which AI response is better and WHY
  - **Chatbot Conversation** → Have a natural multi-turn conversation
  - **Fact-Checking** → Cross-reference claims against live web sources
...
1. **Analytical Breakdown** — The detailed reasoning (which response is better, why, what's wrong with the other)
2. **Human-Voice Draft** — A rewritten version in natural, conversational language that the user can type
...
| Task Type | What AI Does | Speed Target |
|---|---|---|
| Response A vs B comparison | Research both responses, identify errors, write justification | < 2 min |
| Chatbot conversation | Suggest natural conversation topics and responses | < 1 min |
| Fact-checking | Cross-reference every claim against live sources | < 3 min |
| Coding problem | Solve in /tmp/, verify output, explain solution | < 5 min |
| Design critique | Apply Visual Hierarchy, Accessibility, UX principles | < 3 min |

## What Made Us Pass the Assessments
